...
public class ProtocolFunctions {
  ...
  public static class ServiceNameLookup implements DrillSimpleFunc {
    ...
    public void setup() {
      serviceInfo = org.apache.drill.contrib.function.SecurityHelperFunctions.getPortHashMap();
    }
  ...
  /**
   * This function accepts a port number that is a string and returns the service name
   *
   * @Param portNumber
